#legacySQL
SELECT
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\._distributor_init|from (numpy|np)\s+import\s+_distributor_init|from\s+(numpy|np)\.?_distributor_init import\s+[A-za-z0-9_.]+)' ) AS numpy_module__distributor_init,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\._globals|from (numpy|np)\s+import\s+_globals|from\s+(numpy|np)\.?_globals import\s+[A-za-z0-9_.]+)' ) AS numpy_module__globals,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\._import_tools|from (numpy|np)\s+import\s+_import_tools|from\s+(numpy|np)\.?_import_tools import\s+[A-za-z0-9_.]+)' ) AS numpy_module__import_tools,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\._mat|from (numpy|np)\s+import\s+_mat|from\s+(numpy|np)\.?_mat import\s+[A-za-z0-9_.]+)' ) AS numpy_module__mat,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\._mklinit|from (numpy|np)\s+import\s+_mklinit|from\s+(numpy|np)\.?_mklinit import\s+[A-za-z0-9_.]+)' ) AS numpy_module__mklinit,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.add_newdocs|from (numpy|np)\s+import\s+add_newdocs|from\s+(numpy|np)\.?add_newdocs import\s+[A-za-z0-9_.]+)' ) AS numpy_module_add_newdocs,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.char|from (numpy|np)\s+import\s+char|from\s+(numpy|np)\.?char import\s+[A-za-z0-9_.]+)' ) AS numpy_module_char,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.compat|from (numpy|np)\s+import\s+compat|from\s+(numpy|np)\.?compat import\s+[A-za-z0-9_.]+)' ) AS numpy_module_compat,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.core|from (numpy|np)\s+import\s+core|from\s+(numpy|np)\.?core import\s+[A-za-z0-9_.]+)' ) AS numpy_module_core,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.ctypeslib|from (numpy|np)\s+import\s+ctypeslib|from\s+(numpy|np)\.?ctypeslib import\s+[A-za-z0-9_.]+)' ) AS numpy_module_ctypeslib,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.emath|from (numpy|np)\s+import\s+emath|from\s+(numpy|np)\.?emath import\s+[A-za-z0-9_.]+)' ) AS numpy_module_emath,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.fft|from (numpy|np)\s+import\s+fft|from\s+(numpy|np)\.?fft import\s+[A-za-z0-9_.]+)' ) AS numpy_module_fft,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.lib|from (numpy|np)\s+import\s+lib|from\s+(numpy|np)\.?lib import\s+[A-za-z0-9_.]+)' ) AS numpy_module_lib,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.linalg|from (numpy|np)\s+import\s+linalg|from\s+(numpy|np)\.?linalg import\s+[A-za-z0-9_.]+)' ) AS numpy_module_linalg,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.ma|from (numpy|np)\s+import\s+ma|from\s+(numpy|np)\.?ma import\s+[A-za-z0-9_.]+)' ) AS numpy_module_ma,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.math|from (numpy|np)\s+import\s+math|from\s+(numpy|np)\.?math import\s+[A-za-z0-9_.]+)' ) AS numpy_module_math,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.matrixlib|from (numpy|np)\s+import\s+matrixlib|from\s+(numpy|np)\.?matrixlib import\s+[A-za-z0-9_.]+)' ) AS numpy_module_matrixlib,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.polynomial|from (numpy|np)\s+import\s+polynomial|from\s+(numpy|np)\.?polynomial import\s+[A-za-z0-9_.]+)' ) AS numpy_module_polynomial,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.random|from (numpy|np)\s+import\s+random|from\s+(numpy|np)\.?random import\s+[A-za-z0-9_.]+)' ) AS numpy_module_random,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.rec|from (numpy|np)\s+import\s+rec|from\s+(numpy|np)\.?rec import\s+[A-za-z0-9_.]+)' ) AS numpy_module_rec,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.sys|from (numpy|np)\s+import\s+sys|from\s+(numpy|np)\.?sys import\s+[A-za-z0-9_.]+)' ) AS numpy_module_sys,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.testing|from (numpy|np)\s+import\s+testing|from\s+(numpy|np)\.?testing import\s+[A-za-z0-9_.]+)' ) AS numpy_module_testing,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.version|from (numpy|np)\s+import\s+version|from\s+(numpy|np)\.?version import\s+[A-za-z0-9_.]+)' ) AS numpy_module_version,
REGEXP_MATCH(c.content,'(import\s+(numpy|np)\.warnings|from (numpy|np)\s+import\s+warnings|from\s+(numpy|np)\.?warnings import\s+[A-za-z0-9_.]+)' ) AS numpy_module_warnings,
